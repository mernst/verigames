 ...
 * <p>
 * A {@link verigames.level.World World} represents a single game for Pipe Jam. No two
 ...
 * <p>
 * Each {@code World} contains an arbitrary number of {@link verigames.level.Level
 * Level}s. {@code Level}s can be dependent on one another. Each level
 * represents a class in a Java project.
 * <p>
 * Each {@code Level} contains an arbitrary number of {@link verigames.level.Board}s.
 ...
 * essentially a DAG with {@link verigames.level.Chute Chute}s as edges and {@link
 ...
 * verigames.level.Subnetwork Subnetwork} and {@link verigames.level.NullTest NullTest}, more
 * meaning is carried.
 * <p>
