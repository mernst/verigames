...
{
   /**
    * Tests that the getStartPort accessor throws an IllegalStateException if there is no starting Intersection
    */
   ...
   /**
    * Tests that the getEndPort accessor throws an IllegalStateException if there is no ending Intersection
    */
