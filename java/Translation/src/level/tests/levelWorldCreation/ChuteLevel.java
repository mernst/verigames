...
public class ChuteLevel
{
   ...
   private static void addConstructor(Level level, Map<String, Chute> fieldToChute)
   {
      ...
      {
         Chute auxArg = new Chute("aux", true);
         ...
         Chute auxArg2 = new Chute("aux", true);
         constructor.addEdge(merge, 0, end, 0, auxArg2);
         
         level.makeLinked(new HashSet<Chute>(Arrays.asList(auxArg, auxArg2)));
      ...
      {
         Chute start = new Chute("aux.elts", true);
         ...
         level.makeLinked(new HashSet<Chute>(Arrays.asList(start, leftBranch, rightBranchStart, rightBranchEnd, end)));
      }
      ...
      // Construct start and end chutes
      {
         ...
         Chute start = new Chute("start", true);
         Chute end = new Chute("end", true);
      ...
      // Construct auxiliaryChutes (the field) base chutes
      {
         ...
         Chute auxChutesLeft = new Chute("auxiliaryChutes", true);
         ...
         level.makeLinked(new HashSet<Chute>(Arrays.asList(auxChutesLeft, auxChutesRight, auxChutesEnd)));
      ...
      // Construct auxiliaryChutes (the field) aux chutes
      {
         ...
         Chute left = new Chute("auxiliaryChutes.elts", true);
         constructor.addEdge(startLeft, 0, merge, 0, left);
         Chute end = new Chute("auxiliaryChutes.elts", true);
         constructor.addEdge(merge, 0, outgoing, 2, end);
         Chute right = new Chute("auxiliaryChutes.elts", true);
   ...
   private static void addGetName(Level level, Map<String, Chute> fieldToChute)
   {
      ...
      // Add name chute:
      {
         ...
         Chute start = new Chute("name", true);
         ...
         level.makeLinked(new HashSet<Chute>(Arrays.asList(
   ...
   private static void addSetStart(Level level, Map<String, Chute> fieldToChute)
   {
      ...
      // Add start chutes:
      {
         ...
         Chute arg = new Chute(null, true);
         Chute argEnd = arg.copy();
         
         Chute inBetween = arg.copy();
         
         Chute firstStart = new Chute("start", true);
         ...
         level.makeLinked(new HashSet<Chute>(Arrays.asList(firstStart,
         ...
         level.makeLinked(new HashSet<Chute>(Arrays.asList(arg, argEnd,
               inBetween)));
      }
   ...
   private static void addGetStart(Level level, Map<String, Chute> fieldToChute)
   {
      ...
      // Add start chutes:
      {
         ...
         level.makeLinked(new HashSet<Chute>(Arrays.asList(start, end, ret,
   ...
   private static void addSetEnd(Level level, Map<String, Chute> fieldToChute)
   {
      ...
      // Add end chutes:
      {
         ...
         Chute firstStart = new Chute("end", true);
         Chute lastStart = firstStart.copy();
   ...
   private static void addGetEnd(Level level, Map<String, Chute> fieldToChute)
   {
      ...
      // Add End chutes:
      {
         ...
         Chute start = new Chute("end", true);
         Chute end = start.copy();
         Chute ret = new Chute(null, true);
   ...
   private static void addCopy(Level level, Map<String, Chute> fieldToChute)
   {
      ...
      // Add start chutes:
      {
         Chute top = new Chute("start", true);
         Chute bottom = top.copy();
      ...
      // Add end chutes:
      {
         ...
         level.makeLinked(top, bottom, fieldToChute.get("start"));
      }
      ...
      // Add copyAuxChutes base chute:
      {
         ...
         Chute copyAux = new Chute("copyAuxChutes", true);
   ...
   private static void addTraverseAuxChutes(Level level, Map<String, Chute> fieldToChute)
   {
      ...
      // auxiliaryChutes base chutes:
      {
         ...
         level.makeLinked(top, middle, bottom, fieldToChute.get("auxiliaryChutes"));
      }
      ...
      // auxiliaryChutes aux chutes:
      {
         ...
         level.makeLinked(top, middle, bottom, fieldToChute.get("auxiliaryChutes.elts"));
      }
      ...
      // start chutes:
      {
         ...
         level.makeLinked(top, middle, bottom, fieldToChute.get("start"));
      }
      
      // end chutes:
      {
         Chute top = new Chute("end", true);
         Chute middle = top.copy();
         Chute bottom = top.copy();
         ...
         level.makeLinked(top, middle, bottom, fieldToChute.get("end"));
      }
      ...
      // allAuxChuteTraversals base chute:
      {
         ...
         Chute chute = new Chute("allAuxChuteTraversals", true);
      ...
      travAux.addNode(traverseAuxMerge);
      {
         ...
         Chute top = new Chute("allAuxChuteTraversals.elts", true);
      ...
      // getAuxiliaryChutes return value aux chutes:
      {
         ...
         Chute retAux1 = new Chute(null, true);
      ...
      // traverseAuxChutes return value aux chutes:
      {
         ...
         Chute ret1 = new Chute(null, true);
