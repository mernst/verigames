...
public class DotParserSpecTests
{
   private static final String testInput =
      ...
      static
      {
         ...
         builder.setGraphAttributes(new GraphInformation.GraphAttributes(21700, 52800));

         builder.setNodeAttributes("8", new GraphInformation.NodeAttributes(10164, 45600, 14400, 7200));
