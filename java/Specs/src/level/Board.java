 ...
 * 
 * An ADT representing a directed Graph that stores data in both nodes and edges
 * 
 * @specfield: Nodes -- Set<Intersection> // the set of nodes contained in the Graph
...
public class Board
{
   ...
   /**
    * @returns a Set<Intersection> with all node objects in this graph, in no particular
    *          order. The returned list will not be affected by future changes
    *          to this object, and changes to the returned list will not affect
    *          this object.
    */
