...
def update_qid(prefix):
	...
	level_obj_ordered = _util.sort_full_json(process_obj(level_obj, LEVEL_KEYS))
	assignments_obj_ordered = _util.sort_full_json(process_obj(assignments_obj, ASSIGNMENTS_KEYS))
