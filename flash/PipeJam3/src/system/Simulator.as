...
{	
	...
	public class Simulator 
	{
		...
		/* The network in which the Simulator detects trouble points */
		...
		private var boards_to_update:Vector.<BoardNodes>;
		
		/* The constuctor takes a network in which the Simulator will detect trouble points
		 * 
		 * @param: _network, the current network
		 */
		public function Simulator(_network:Network) 
		{
			m_network = _network;
...
//		}
		...
		{
			boards_to_update = new Vector.<BoardNodes>;
			
			for each(var levelNodes:LevelNodes in m_network.LevelNodesDictionary) 
			{
				var new_boards_to_update:Vector.<BoardNodes> = updateOnPipeClickFlowSens("", levelNodes.boardNodesDictionary);
		...
		public function simulateLinkedPipes(mainEdge:Edge, simulator:Simulator):Vector.<BoardNodes> 
		{
//			boards_to_update = new Vector.<BoardNodes>;
//			var levels_to_update:Vector.<LevelNodes> = updateOnPipeClick(mainEdge.linked_edge_set);
//			simulatorUpdateTroublePoints(levels_to_update);
...
//								}
//							}
//				boards_to_update = updateOnPipeClickFlowSens(mainEdge.  .edge_set_id, boards_affected);
//			}
